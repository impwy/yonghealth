...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="bg-gradient-to-r from-primary-600 to-primary-700 text-white shadow-md">
        <div className="max-w-4xl mx-auto px-3 py-3 md:px-4 flex items-center justify-between">
          <Link href="/" className="text-lg md:text-xl font-bold tracking-tight flex items-center gap-1.5">
            <span>🏋️</span> YongHealth
          </Link>
